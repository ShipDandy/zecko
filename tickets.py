...
def agent_tickets(zd_id):
    ...
    solved_ticket_raw = requests.get("https://shipstation.zendesk.com/api/v2/search.json?query=type:ticket status:solved assignee:{} solved:{} -channel:chat".format(zd_id, query_date), headers=zd_creds.zd_headers)
